  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="font-bold">three year</span> of indusry experience. I
        enjoy building <span className="italic">REST & Web Applications</span>.
        My main focus is{" "}
        <span className="underline">
          ASP.NET, ASP.Net Core, React.JS & Node.JS
        </span>
        .
      </motion.p>
      ...
      >
        ...
        >
          Contact Me Here.{" "}
          <BsArrowRight className="opacity-70 group-hover:translate-x-1 transistion" />
        </Link>
        <a
